 ...
 */
@Immutable
final class NatsPublishTarget implements PublishTarget {
    ...
    private NatsPublishTarget(final String topic, @Nullable final String key, @Nullable final Integer partition) {
        this.topic = topic;
        this.key = key;
        this.partition = partition;
    }

    static NatsPublishTarget fromTargetAddress(final String targetAddress) {
    ...
    private static NatsPublishTarget fromTargetAddressWithKey(final String targetAddress) {
        ...
        return new NatsPublishTarget(topic, key, null);
    }
    ...
    private static NatsPublishTarget fromTargetAddressWithPartition(final String targetAddress) {
        final String[] split = targetAddress.split(PARTITION_SEPARATOR, 2);
        final String topic = validateTopic(split[0]);
        final Integer partition = validatePartition(split[1]);
        return new NatsPublishTarget(topic, null, partition);
    }
    ...
    private static NatsPublishTarget fromTargetAddressWithOnlyTopic(final String targetAddress) {
        validateTopic(targetAddress);
        return new NatsPublishTarget(targetAddress, null, null);
    }
    ...
    public boolean equals(@Nullable final Object o) {
        ...
        final NatsPublishTarget that = (NatsPublishTarget) o;
