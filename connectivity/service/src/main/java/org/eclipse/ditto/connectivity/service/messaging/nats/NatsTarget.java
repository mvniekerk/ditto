...
final class NatsTarget implements PublishTarget {
    ...
    static NatsTarget of(final String exchange, final String routingKey) {
        return new NatsTarget(exchange, routingKey);
    }

    private NatsTarget(final String exchange, @Nullable final String routingKey) {
